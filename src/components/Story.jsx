      ...
      <div className="container">
        <div className="about__inner" style={{ display: 'flex', flexDirection: 'column', textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div className="section__description reveal reveal-delay-2" style={{ fontSize: '1.125rem', color: '#444', maxWidth: '100%', textAlign: 'center', marginTop: '2rem' }}>
            <p style={{ marginBottom: '1.5rem' }}>We are ThinkDiffrent, a team united by a passion for technology, innovation, and solving meaningful problems. For years, we explored ideas, built projects, learned from failures, and dreamed about creating something that could make a real impact.</p>
